...
<main class="main_top">
    ...
    <div class="bt_top">
        <div class="bt">
            <a class="bt_more add" href="{{ url('wb-admin/production/add') }}">
                        ...
                        <label for="post0{{ $post->id }}">
                            ...
                            <div class="list_box">
                                ...
                                <div class="list_ttl">
                                    ...
                                    <label class="tgl_bt display"><span>{{ link_to_route('wb-admin.production.display', '表示中', $post->id.'?page='.request('page')) }}</span></label>
                                    @else
                                    <label class="tgl_bt hide"><span>{{ link_to_route('wb-admin.production.display', '非表示', $post->id.'?page='.request('page')) }}</span></label>
                                    @endif
                                    <b>{{ $post->title }}</b>
                                </div>
                                ...
                                <div class="bt">
                                    <a class="bt_edit" href="{{ url('wb-admin/production/edit/'.$post->id) }}">
    ...
    <div class="fix_bt">
        <a class="bt_center add" href="{{ url('wb-admin/production/add') }}">
            <span class="material-icons">add_circle_outline</span>追加する
        </a>
