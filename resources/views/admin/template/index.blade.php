...
<main class="main_top">
    ...
    <div class="bt_top">
        <div class="bt">
            <a class="bt_more add" href="{{ url('wb-admin/template/add') }}">
                <span class="material-icons">add_circle_outline</span>追加する
            </a>
            <a class="bt_more sort" href="{{ url('wb-admin/template/sort') }}">
                                ...
                                <div class="list_box">
                                    ...
                                    <div class="list_ttl">
                                        @if ($item->display == config('custom.display.on'))
                                            <label class="tgl_bt display"><span>{{ link_to_route('wb-admin.template.display', '表示中', $item->id) }}</span></label>
                                        @else
                                            <label class="tgl_bt hide"><span>{{ link_to_route('wb-admin.template.display', '非表示', $item->id) }}</span></label>
                                        @endif
                                        <b>{{ $item->name }}</b>
                                    </div>
                                    ...
                                    <div class="bt">
                                        <a class="bt_edit" href="{{ url('wb-admin/template/edit/'.$item->id) }}">
    ...
    <div class="fix_bt">
        <a class="bt_center add" href="{{ url('wb-admin/template/add') }}">
            <span class="material-icons">add_circle_outline</span>追加する
        </a>
